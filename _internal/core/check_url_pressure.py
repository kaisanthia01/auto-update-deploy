...
logger = logging.getLogger("CheckURLPressure")
...
class CheckURLPressure:
    ...
    def save_json(self, data: list):
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))  # ตำแหน่งไฟล์ .py
        output_path = os.path.join(script_dir, "../data/json/synop_url_pressure.json")
...
# checker = CheckURLPressure()
# date_str = "2025-03-25"
# time_str = "0000"  # หรือ "1200"
#
# result, message = checker.urlGetContent(time_str, date_str)
# print("📋 สถานะ:", message)
#
