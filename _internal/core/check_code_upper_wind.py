...
logger = logging.getLogger("CheckCodeUpperWind")


class CheckCodeUpperWind:
    ...
    def save_decoded_to_json(self, decoded, time_str, date):
        try:
