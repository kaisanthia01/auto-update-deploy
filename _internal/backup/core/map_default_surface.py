...
# paper_key = "อต.ทอ.1001"  # ตัวอย่าง: "อต.ทอ.1001"
...
ax.text(
    45.06,  # ลองจิจูด (Longitude)
    -29.94,  # ละติจูด (Latitude)
    f"Date: XX XXX XXXX Time: XXXX UTC | Surface Map",  # ข้อความ
    transform=ccrs.PlateCarree(),  # ใช้พิกัดบนแผนที่
